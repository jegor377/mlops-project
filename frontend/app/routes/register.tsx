...
export default function RegisterPage() {
  ...
  const prepareOIDCUrl = (url: string): string => {
    ...
    if (subscriptionPlan) {
      oidcUrlSearchParams.set("plan", subscriptionPlan);
    }

    const queryString = oidcUrlSearchParams.toString();
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-8 sm:px-6">
      ...
      <div className="w-full max-w-md bg-white border border-gray-100 rounded-2xl shadow-xl shadow-gray-200/60 p-6 sm:p-8 mt-16">
        ...
        <div className="space-y-2 sm:space-y-3">
          <a href={prepareOIDCUrl("/auth/login_via/google")} className="w-full flex items-center justify-center gap-2 border border-gray-200 rounded-lg py-2 sm:py-2.5 text-sm hover:bg-gray-50 transition cursor-pointer">
          ...
          <a href={prepareOIDCUrl("/auth/login_via/github")} className="w-full flex items-center justify-center gap-2 border border-gray-200 rounded-lg py-2 sm:py-2.5 text-sm hover:bg-gray-50 transition cursor-pointer">
